...
const slides = [
  {
    ...
    sub: 'AC · Fridge · Washing Machine · Geyser · Microwave — Verified Technician, 30-Day Warranty.',
  ...
  },
  {
    ...
    sub: 'Trained technicians, genuine parts, proper bill. AC, fridge, washing machine — sab ek jagah.',
    stats: [['Same Day', 'Service'], ['Proper', 'Bill'], ['30-Day', 'Warranty']],
