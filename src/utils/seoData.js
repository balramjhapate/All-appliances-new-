...
export const SEO_CITIES = {
  indore: {
    ...
    reviews: [
      { name: 'Rahul Sharma', area: 'Vijay Nagar', service: 'AC Repair', text: 'Voltas AC bilkul thanda nahi kar raha tha, 43°C ki garmi mein bahut takleef thi. Call kiya aur exactly 45 minute mein technician aa gaya. Gas refill + full service, ₹799 liya — fair price. GST invoice bhi mili. Highly recommend!' },
    ...
    areaIntros: {
      ...
      'ab-road': 'AB Road (Agra-Bombay Highway) — Indore ka sabse lamba commercial corridor, Annapurna se Lasudia Mori tak — pe hamare technician 20–30 minute mein pohonchte hain. Bhawarkuan aur Pardesipura aas-paas hain. GST invoice, 30-day warranty.',
      ...
      'hig-colony': 'HIG Colony — Indore ke HIG Square ke aas-paas ka upscale residential zone, Sukhliya aur Annapurna ke adjacent — mein hum 25–35 minute mein certified technician bhejte hain. GST invoice aur 30-day warranty guaranteed.',
      ...
      'bhawarkuan': 'Bhawarkuan — Indore ki Bypass Road ke paas, RTO office ke adjacent — AB Road aur Rajendra Nagar bilkul karib hain. Hum 25–30 minute mein service dete hain. 30-day warranty aur GST invoice har repair pe guaranteed.',
      ...
      'bengali-square': 'Bengali Square — Indore ka prominent chauraha, MG Road aur AB Road corridor ke beech — Geeta Bhawan aur Annapurna bilkul aas-paas hain. Hamare base se 20–25 minute mein service. GST invoice, 30-day warranty.',
      ...
      'sukhliya': 'Sukhliya — HIG Colony aur Annapurna ke beech residential area, AB Road corridor se well-connected — mein hum 25–35 minute mein service dete hain. Same-day repair, 30-day warranty, GST invoice guarantee.',
      ...
      'saket-nagar': 'Saket Nagar — Pardesipura aur AB Road ke beech established residential area, commercial corridor se well-connected — mein hum 20–30 minute mein doorstep service dete hain. GST invoice, 30-day warranty.',
  ...
  bhopal: {
    ...
    intros: {
      ...
      'refrigerator-repair': "Bhopal ki garmi mein — MP ki rajdhani ki khuli sadkon pe temperature 44°C tak pohonchta hai — fridge ka thanda nahi karna ghar ka routine bigad deta hai. Arera Hills, Govindpura aur Piplani mein hum fridge repair karte hain. Compressor, gas refill ya thermostat — 60 minute mein, GST invoice guarantee.",
      ...
      'microwave-repair': "Bhopal mein Habibganj, Shyamla Hills aur New Market ke busy households mein microwave ka band hona daily routine ko affect karta hai. Hum magnetron, turntable, door fault aur PCB repair karte hain — 60 minute mein, koi hidden charge nahi, GST invoice.",
    ...
    areaIntros: {
      ...
      'kolar-road': 'Kolar Road — Kolar se Bairagarh tak Bhopal ka southern arterial road, Kolar aur Misrod ke adjacent — pe kai residential pockets hain. Hum 25–35 minute mein doorstep service dete hain. GST invoice, 30-day warranty.',
      ...
      'katara-hills': 'Katara Hills — Kolar ke paas Bhopal ka scenic hilltop residential area, Kolar Road se connected quiet green locality — mein hum 30–40 minute mein doorstep service dete hain. ₹350 se shuru, GST invoice.',
      ...
      'bhel': 'BHEL — Heavy Electricals ka planned township, Piplani aur Govindpura se connected well-maintained residential colony — mein hum 30–40 minute mein certified technician bhejte hain. GST invoice, 30-day warranty.',
      ...
      'misrod': 'Misrod — Bhopal ka eastern suburb, Hoshangabad Road pe, Chunabhatti aur Kolar Road ke adjacent growing residential area — mein hum 30–40 minute mein service dete hain. ₹350 se shuru, GST invoice.',
      ...
      'shyamla-hills': 'Shyamla Hills — Bhopal ka green hilltop residential area, Arera Colony aur Habibganj ke adjacent, CM residence bhi yahan — mein hum 20–30 minute mein service dete hain. GST invoice, 30-day warranty guaranteed.',
      ...
      'arera-hills': 'Arera Hills — Arera Colony ke extension mein hilltop residential area, Shyamla Hills aur Habibganj ke paas premium locality — mein hum 20–30 minute mein service dete hain. GST invoice, 30-day warranty.',
  ...
  mhow: {
    ...
    intros: {
      ...
      'refrigerator-repair': 'Mhow mein fridge repair ke liye — Cantonment area se New Mhow tak — hum same-day technician bhejte hain. Gas refill se compressor fault tak, fair price, GST invoice.',
  ...
  dewas: {
    ...
    intros: {
      ...
      'refrigerator-repair': 'Dewas mein fridge repair ke liye — Sai Nagar se Manavar Road tak — hum same-day technician bhejte hain. Compressor, gas refill ya thermostat — fair price, GST invoice.',
  ...
  sehore: {
    ...
    intros: {
      ...
      'refrigerator-repair': 'Sehore mein fridge repair ke liye hum Kotwali Area, Bhopal Road aur Ashta area mein same-day technician bhejte hain. Gas refill se compressor — fair price, GST invoice.',
