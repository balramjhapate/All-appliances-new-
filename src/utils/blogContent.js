      ...
      sections: [
        {
          ...
          body: 'Basic Service/Cleaning: ₹350-499 (filter clean, coil clean, check). Gas Top-Up (R22): ₹500-800. Gas Top-Up (R32/R410A): ₹800-1,500. Compressor Replacement: ₹2,000-8,000 (brand aur model pe depends). PCB Repair: ₹500-2,000. Fan Motor: ₹800-1,500. Full Installation (new AC): ₹1,200-2,000.',
        },
        {
          heading: 'Bhopal mein AC Service Cost (2025)',
          body: 'Bhopal mein pricing Indore se roughly same hai — 10-15% variation possible. Basic Service: ₹350-549. Gas Refill: ₹500-1,600. Compressor: ₹2,500-8,500. Installation: ₹1,200-1,800. Note: Company-brand service centers zyaada charge karte hain — local trusted technicians se same quality mein better price milta hai.',
        },
        {
