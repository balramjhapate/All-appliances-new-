...
import { IMG_LP_FRIDGE_HERO, IMG_LP_FRIDGE_TECH } from '@/utils/cdn';

export const metadata = {
  title: 'Fridge Repair in Bhopal – 60 Min Doorstep | ₹350',
  description:
    'Fridge not cooling in Bhopal? Same-day doorstep fridge repair at ₹350, 60-min response, 30-day warranty. All brands. Call +91 8889539174.',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://homerepairpro.in/lp/fridge-repair-bhopal' },
  openGraph: {
    title: 'Fridge Repair in Bhopal – 60 Min Doorstep | ₹350',
    description: 'Fridge not cooling in Bhopal? Same-day doorstep fridge repair at ₹350, 60-min response, 30-day warranty. All brands. Call +91 8889539174.',
    url: 'https://homerepairpro.in/lp/fridge-repair-bhopal',
    siteName: 'HomeRepairPro',
    type: 'website',
    images: [{ url: 'https://homerepairpro.in/images/lp/lp-fridge-hero.png', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Fridge Repair in Bhopal – 60 Min Doorstep | ₹350',
    description: 'Fridge not cooling in Bhopal? Same-day doorstep fridge repair at ₹350, 60-min response, 30-day warranty.',
    images: ['https://homerepairpro.in/images/lp/lp-fridge-hero.png'],
  },
};

const SERVICE = 'Refrigerator Repair';
const CITY = 'Bhopal';
const LP_URL = 'https://homerepairpro.in/lp/fridge-repair-bhopal';
const WA_TEXT = 'Hi HomeRepairPro! Mujhe Bhopal mein fridge repair chahiye. Please jaldi callback karo. 🙏';
...
const PROBLEMS = [
  { icon: '🧊', title: 'Not cooling' },
  { icon: '💨', title: 'Gas leak / refill' },
  { icon: '🔧', title: 'Compressor fault' },
  { icon: '💧', title: 'Water leakage' },
  { icon: '❄️', title: 'Excess ice / freezing' },
  { icon: '🔊', title: 'Noise from fridge' },
  { icon: '🔌', title: 'Not turning on' },
  { icon: '🌡️', title: 'Thermostat / sensor' },
];
...
const PRICING = [
  { service: 'Fridge Inspection / Basic Visit', price: '₹350' },
  { service: 'Gas Refill (single/double door)', price: '₹1,200–₹2,000' },
  { service: 'Cooling / Thermostat Repair', price: '₹500–₹1,200' },
  { service: 'Compressor Repair/Replace', price: '₹1,800–₹3,500' },
];
...
const REVIEWS = [
  {
    text: 'Samsung fridge 3 din se thanda nahi kar rahi thi, ghar ka saara saaman kharab ho raha tha. HomeRepairPro ko call kiya, 1 ghante mein technician aaya, thermostat fix kiya. Ab ekdum sahi. Best service!',
    name: 'Amit Patel',
    area: 'Kolar, Bhopal',
  },
  {
...
const FAQS = [
  { q: 'Bhopal mein fridge repair ka charge kya hai?', a: 'Fridge repair Bhopal mein inspection ₹350 se shuru. Gas refill ₹1,200–₹2,000. Pehle free estimate — koi obligation nahi.' },
  { q: 'Same day fridge repair milta hai?', a: 'Haan, call ke 60 minute mein Bhopal ke kisi bhi area mein technician aata hai.' },
  { q: 'Kaunse brands repair karte ho?', a: 'LG, Samsung, Whirlpool, Godrej, Haier, Panasonic — sab brands.' },
...
export default function FridgeRepairBhopalLP() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: ld(breadcrumbSchema([{ name: 'Home', url: 'https://homerepairpro.in' }, { name: 'Fridge Repair Bhopal', url: LP_URL }])) }} />
        ...
        <div>
          ...
          <div className="md:hidden">
            ...
            <div className="relative h-60 overflow-hidden">
              <Image
                src={IMG_LP_FRIDGE_HERO}
                alt="Technician repairing a refrigerator at a home in Bhopal"
                fill
              ...
              <div className="absolute bottom-0 left-0 right-0 px-5 pb-4">
                <h1 className="text-white text-[1.5rem] font-extrabold leading-tight drop-shadow">
                  ...
                  <span className="block text-[#F97316]">60 Min Mein Repair — Bhopal</span>
                </h1>
              </div>
            </div>
            ...
            <div className="px-4 pt-4">
              <div className="bg-white rounded-2xl shadow-xl p-5 border border-gray-100">
                ...
                <LpLeadForm
                  sourceComponent="lp_fridge_form"
                  waSourceComponent="lp_fridge_whatsapp"
                  callSourceComponent="lp_fridge_call"
          ...
          <div className="hidden md:flex" style={{ minHeight: 'calc(100vh - 104px)' }}>
            ...
            <div className="w-[360px] xl:w-[400px] flex-shrink-0 flex flex-col justify-center px-6 py-10 relative z-20
              ...
              <div className="mb-5">
                ...
                <h2 className="text-xl font-black text-[#06112a] leading-snug">Fridge Repair Book Karein</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900">Fridge Ki Kaunsi Problem Fix Karte Hain?</h2>
        ...
        <div className="max-w-5xl mx-auto px-4 md:flex md:items-center md:gap-12">
          <div className="flex justify-center mb-8 md:mb-0 md:flex-shrink-0">
            <div className="relative">
              <Image
                src={IMG_LP_FRIDGE_TECH}
                alt="HomeRepairPro verified fridge repair technician in Bhopal"
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900">3 Steps Mein Fridge Repair</h2>
          </div>
      ...
      <section className="py-8 md:py-12 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-xl md:text-2xl font-extrabold text-gray-900 mb-5">Sab Brands Ki Fridge Repair Karte Hain</h2>
          ...
          <p className="text-xs text-gray-400 mt-4">Single door · Double door · Side-by-side — sab types</p>
        </div>
      </section>
      ...
      <section className="bg-[#071a4f] py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-3">Fridge Repair Chahiye Bhopal Mein?</h2>
          <p className="text-blue-200 text-base mb-7">60 minute mein technician — pehle price batate hain. Koi obligation nahi.</p>
          <LpCTAButtons waSourceComponent="lp_fridge_whatsapp" callSourceComponent="lp_fridge_call" service={SERVICE} waText={WA_TEXT} />
          <div className="mt-8 bg-white rounded-2xl p-6 max-w-md mx-auto text-gray-900 shadow-2xl">
            <LpLeadForm sourceComponent="lp_fridge_form" waSourceComponent="lp_fridge_whatsapp" callSourceComponent="lp_fridge_call" defaultService={SERVICE} defaultCity={CITY} />
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-900 border-t border-gray-800 py-5">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-xs text-gray-500 leading-relaxed">
            <strong className="text-gray-400">Fridge repair in Bhopal</strong> — Kolar, MP Nagar, Arera Colony, Awadhpuri, Bairagarh,
            Katara Hills, Karond, Piplani, Shahpura, Govindpura, Misrod, Bag Mugaliya aur poore Bhopal mein same-day service.
            Samsung fridge repair Bhopal · LG fridge repair Bhopal · Whirlpool refrigerator repair Bhopal ·
            Fridge gas filling Bhopal · Double door fridge repair Bhopal.
          </p>
        </div>
      </section>
    </>
